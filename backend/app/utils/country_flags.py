...
def country_to_flag(country_name: str | None) -> str:
    country = (country_name or "").strip()
    if not country:
        return DEFAULT_FLAG_CODEPOINT
    return COUNTRY_FLAG_MAP.get(country, DEFAULT_FLAG_CODEPOINT)
